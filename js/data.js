...
function new_row(id, amount, gain, interval, type){
    ...
    document.getElementById('sources-body').innerHTML += '<tr>'
      ...
      + '<td><input id="' + row_id + '-amount" value="' + amount + '" type=number>'
      + '<td id="' + row_id + '-percent">'
      + '<td><input class=mini id="' + row_id + '-gain" value="' + gain + '" type=number>'
        + '<select id="' + row_id + '-type"><option value=%>%</option><option value=+>+</option></select>'
      + '<td><input class=mini id="' + row_id + '-interval" value="' + interval + '" type=number>'
      + '<td id="' + row_id + '-total">'
